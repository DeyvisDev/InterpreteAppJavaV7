...
public class ModuloNormalModel {
    String tituloSordo, descripcionSordo, tituloNormal, descripcionNormal, fecha, hora, usuario, imgSubir, categoria;
    ModuloNormalModel(){

    }

    public ModuloNormalModel(String tituloSordo, String descripcionSordo, String tituloNormal, String descripcionNormal, String fecha, String hora, String usuario, String imgSubir, String categoria) {
